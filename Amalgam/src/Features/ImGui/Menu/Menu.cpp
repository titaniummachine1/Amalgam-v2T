		...
		if (BeginTable("MiscTable", 2))
		{
			...
			TableNextColumn();
			{
				if (Section("Movement"))
				{
					...
					FToggle(Vars::Misc::Movement::EdgeJump, FToggleEnum::Left);
					...
					FToggle(Vars::Misc::Movement::DuckJump, FToggleEnum::Left);
					FToggle(Vars::Misc::Movement::ShieldTurnRate, FToggleEnum::Right);
					FToggle(Vars::Misc::Movement::LedgeGrab, FToggleEnum::Left);
					FToggle(Vars::Misc::Movement::NoPush, FToggleEnum::Right);
					FToggle(Vars::Misc::Movement::SmartJump, FToggleEnum::Left);
		...
		if (BeginTable("NavbotTable", 2))
		{
			...
			FToggle(Vars::Misc::Movement::NavEngine::DisableOnSpectate, FToggleEnum::Left);
					PushTransparent(!Vars::Misc::Movement::NavEngine::Enabled.Value);
					{
						...
						FColorPicker(Vars::Colors::NavbotPortal, FColorPickerEnum::SameLine, {}, { H::Draw.Scale(10), H::Draw.Scale(40) });
						FColorPicker(Vars::Colors::NavbotBlacklist, FColorPickerEnum::SameLine, {}, { H::Draw.Scale(10), H::Draw.Scale(40) });
						FSlider(Vars::Misc::Movement::NavEngine::AreaDrawDepth, FSliderEnum::None);
