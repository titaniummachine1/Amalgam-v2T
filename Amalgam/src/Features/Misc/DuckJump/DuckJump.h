...
private:
	...
	static constexpr float DUCKED_HULL_HEIGHT = 55.f;
	static constexpr float HULL_HEIGHT_DIFF = STANDING_HULL_HEIGHT - DUCKED_HULL_HEIGHT; // 27u
	static constexpr int UNDUCK_TICKS = 14; // 0.2s at 66.67 tickrate
	static constexpr float NARROW_HULL_HALF = 24.f; // 48x48 engine hull (half-width)
