...
private:
	...
	int CanHit(Target_t& tTarget, CTFPlayer* pLocal, CTFWeaponBase* pWeapon, const Vec3* pViewAngles = nullptr, bool bUseViewAnglesForBackstab = false);
	...
	bool m_bForceSwingVisualization = false;
...
public:
	...
	bool RunTriggerbotBackstab(CTFPlayer* pLocal, CTFWeaponBase* pWeapon, CUserCmd* pCmd);
};
